...
#define DBG_FATAL    QOutlog().begin(LOG_LEVEL::LOG_FATAL) << '[' << __FUNCTION__ << "][" << __LINE__ << ']'
#define DBG_ERROR    QOutlog().begin(LOG_LEVEL::LOG_ERROR) << '[' << __FUNCTION__ << "][" << __LINE__ << ']'
#define DBG_WARN     QOutlog().begin(LOG_LEVEL::LOG_WARN)  << '[' << __FUNCTION__ << "][" << __LINE__ << ']'
#define DBG_INFO     QOutlog().begin(LOG_LEVEL::LOG_INFO)  << '[' << __FUNCTION__ << "][" << __LINE__ << ']'
#define DBG_QT_MSG   QOutlog().begin(LOG_LEVEL::LOG_ERROR) << "[QtMsg]"
